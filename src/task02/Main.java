...
//        while ((inputLineFirst = inFirst.readLine()) != null) {
//            initialWords.add(inputLineFirst);
//        }
        ...
        String[] array = words.stream().toArray(String[]::new);// .toArray(words);
...
//        String givenLink = "https://gist.githubusercontent.com/deekayen/4148741/raw/01c6252ccc5b5fb307c1bb899c95989a8a284616/1-1000.txt";
//        WordsProcessing wordsToProcess = new WordsProcessing(givenLink);
//        List<String> words = wordsToProcess.getWords();
    }
}